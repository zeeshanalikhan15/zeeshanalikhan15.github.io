      ...
      <div className="space-y-10">
        <div className="relative bg-white p-8 rounded-md shadow-md text-left lg:text-center">
          <div className="section-content">
            <p className="section-description mb-6 text-sm sm:text-base md:text-lg text-gray-700 text-left lg:text-center">Feel free to reach out to me through any of the following platforms:</p>
            <div className="contact-details flex flex-col items-start lg:items-center">
              ...
              <div className="contact-item mb-6 flex items-center">
                ...
                <p className="break-words"><a href={contactInfoData.linkedin} className="contact-link text-sm sm:text-lg text-blue-600 hover:underline ml-2 break-all">{contactInfoData.linkedin}</a></p>
              </div>
              <div className="contact-item mb-6 flex items-center">
                <FaGithub className="text-xl sm:text-2xl text-gray-800 mr-2" />
                <p className="break-words"><a href={contactInfoData.github} className="contact-link text-sm sm:text-lg text-blue-600 hover:underline ml-2 break-all">{contactInfoData.github}</a></p>
              </div>
            </div>
          </div>
        </div>
