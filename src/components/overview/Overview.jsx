...
const Overview = () => {
    return (
        <section id="overview" className="my-10 md:my-20 mx-auto max-w-5xl px-0 md:px-8">
            <div className="md:glass p-6 md:p-10 rounded-none md:rounded-3xl relative overflow-hidden text-center md:border md:border-white/5 md:hover:border-primary/20 transition-colors duration-500">
                ...
                <h2 className="text-3xl sm:text-4xl font-heading font-bold mb-8 text-white mt-10 md:mt-0">
                    About <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Me</span>
                </h2>

                <div className="prose prose-lg prose-invert mx-auto px-4 md:px-0">
                ...
                <div className="mt-10 flex flex-wrap justify-center gap-4 px-4 md:px-0">
