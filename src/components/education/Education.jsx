                    ...
                    <div key={index} className="md:glass p-0 md:p-8 rounded-none md:rounded-3xl relative overflow-hidden md:border md:border-white/5 md:hover:border-primary/30 transition-all duration-300 border-b border-white/10 pb-8 md:pb-8">
                        ...
                        <div className="flex flex-col md:flex-row items-start mb-8 text-left">
                            ...
                            <div>
                                ...
                                <p className="text-base text-gray-400">{education.period}</p>
                            </div>
                        </div>

                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <div>
                                <h4 className="text-lg font-semibold text-white mb-4 border-b border-white/10 pb-2">Key Courses</h4>
                            ...
                            <div>
                                <h4 className="text-lg font-semibold text-white mb-4 border-b border-white/10 pb-2">Academic Projects</h4>
                                <div className="space-y-6">
                                    {education.projects.map((project, projIndex) => (
                                        <div key={projIndex} className="bg-dark-100/30 p-4 rounded-xl border border-white/5">
                                            <div className="flex items-center mb-2">
                                                <div className="text-accent mr-3 text-xl">
                                                    {project.title.includes('Compiler') ? <FaCode /> : <FaNewspaper />}
                                                </div>
                                                <h5 className="text-md font-bold text-white">{project.title}</h5>
                                            </div>
