                ...
                <div className="relative bg-white p-8 rounded-md shadow-md text-left">
                    ...
                    <div className="relative pl-2 sm:pl-16 mt-2">
                        ...
                        <div className="mb-4">
                            ...
                            <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl mb-4">Technologies: C++, MFC, Cbitmap, Image processing</p>
                        ...
                        <div>
                            ...
                            <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl mb-4">Technologies: Java, CFG, Regular Expressions</p>
